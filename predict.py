...
import sys, os
# Loading the model
json_file = open("C:/Users/Lenovo/Desktop/Real time Hand Gesture Application/gesture-model.json", "r")
model_json = json_file.read()
json_file.close()
loaded_model = model_from_json(model_json)
# load weights into new model
loaded_model.load_weights("C:/Users/Lenovo/Desktop/Real time Hand Gesture Application/gesture-model.h5")
